...
# app.config fails fast if ANTHROPIC_API_KEY is unset (rules.md P0 exit gate) — importing
...
os.environ.setdefault("ANTHROPIC_API_KEY", "sk-test-dummy-not-a-real-key")
